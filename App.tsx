                 ...
                 <div className="flex-grow flex flex-col justify-between h-auto">
                    ...
                    <div className="mt-4">
                        <div className="p-4 bg-gradient-to-br from-[var(--status-error)]/15 to-transparent border border-[var(--status-error)]/30 rounded-2xl space-y-2 border-l-[4px] border-l-[var(--status-error)]">
                            ...
                            <EditableText value={data.highlight_text} isMultiline onChange={(v:string) => setSystemContent({...s, [mode]: {...data, highlight_text: v}})} className="text-[13px] font-extrabold text-[var(--color-text-primary)] uppercase tracking-[0.12em] leather-relaxed italic block" />
                        </div>
                    </div>
                </div>
              </div>
